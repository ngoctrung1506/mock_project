package bu22.fga.mockproject_group2.constant;
...
public class Constant {
  ...
  public static final int DRAP_AND_DROP = 3;
  public static final String EVENT_DRAP = "event drap";
  public static final String EVENT_DROP = "event drop";
